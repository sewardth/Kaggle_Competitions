...
features_train = train_data.drop('target',1).drop('id',1).values.astype(float)
...
#submission_test = scaler.fit_transform(submission_test)
...
sub.to_csv('svmProb.csv', index = False, cols=headers)
